...
export default function AIResponsePanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-white border border-zinc-200 rounded-lg shadow-sm">
      <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-zinc-200 bg-zinc-50/50 flex items-center gap-2 sm:gap-2.5">
        <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-zinc-100 flex items-center justify-center">
          <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-zinc-700" />
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-2 sm:space-y-3 bg-zinc-50/30">
        {aiResponses.length === 0 ? (
